...
const GSSlider: React.FC<NinjaSliderProps> = ({ slides }) => {
    ...
    <div className="relative w-full md:max-w-[1313px]  mx-auto mt-[40px] mb-[63px] bg-gradient-to-b from-[#D9D9D91A] via-[#9a9a9a6a] to-[#D9D9D91A] rounded-[80px]">
      ...
      >
        {slides.map((slide, idx) => (
          ...
          >
            {/* Left Section */}
            <div className="w-[282px] my-auto flex flex-col justify-between ">
            ...
            {/* Center Image */}
            <div className="flex items-center  mt-0 md:-mt-16">
              <Image
                src={slide.image}
                alt={`Slide ${idx + 1}`}
                width={400}
