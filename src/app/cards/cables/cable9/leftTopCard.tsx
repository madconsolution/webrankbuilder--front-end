...
const Cable9ResolutionCardLeftTop: React.FC = () => {
  return (
   <>
       {/* left top card start */}
       <div>
         <div className="grid grid-cols-1  gap-3 w-[660px] h-[796px] text-center bg-[#000000] text-white border-1 border-[#CD2122] rounded-[120px]">
          ...
          <div className='  '>
                 ...
                 <div>
                      ...
                      <div >
                              <Image
               src="/cables/psu4/resolution/left-top.png"
               ...
               />
                                 ...
                                 {/* Left bttom text */}
                 <div className="w-[400px] h-auto mx-auto mt-[10%]  text-[#CD2122]  font-[600] text-[40px] leading-[100%] font-['Open_Sans']">
                     <h5>
...
export default Cable9ResolutionCardLeftTop;