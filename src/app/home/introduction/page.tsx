...
export default function IntroductionSection() {
  return (
    <div className="text-center bg-[#000000] min-h-[200px] flex flex-col items-center justify-center">
      <h3 className="font-bold text-lg md:text-xl ">
        WELCOME TO <span className="text-[#CC0000]">TORTOX</span>
      </h3>
      <p className="w-11/12  mx-auto mt-2 text-sm md:text-base text-gray-700">
