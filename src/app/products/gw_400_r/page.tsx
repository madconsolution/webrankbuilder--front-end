...
type SpecItem = {
  ...
  const slides: SlideContent[] = [
    {
      image: '/gaming/gw_400_r/slider/image.png',
      leftTexts: [
  ...
  const powerItems = [
    {
      ...
      image: "/gaming/gw_400_r/grid/image-1.png",
    },
    {
      ...
      image: "/gaming/gw_400_r/grid/image-2.png",
    },
    {
      ...
      image: "/gaming/gw_400_r/grid/image-3.png",
...
const gw_400_r_page = () => {
  return (
    <div className="w-full md:w-[1440px] mx-auto">
      <CaseBanner
        bgImage="/gaming/gw_400_r/banner.png"
        logo1="/logo.png"
      ...
      <div className="text-xl text-[#FFFFFF]">
        <Title
          ...
          content="The Tortox GD400-B Series is an RGB gaming desk that features a carbon fiber surface, an innovative structural design, and RGB streaming lights on both wings of the table to enhance your gaming experience."
        />
      </div>
       {/*  slider  */}
