  ...
  const powerItems = [
    {
      ...
      image: "/cheir/gs_300_r/grid/image-1.png",
    },
    {
      ...
      image: "/cheir/gs_300_r/grid/image-2.png",
    },
...
const gs_300_r_page = () => {
  return (
    <div className="w-full md:w-[1440px] mx-auto">
      <CaseBanner
        bgImage="/cheir/gs_300_r/banner.png"
        logo1="/logo.png"
        logo2="/cheir/gs_300_r/GS_300R.png"
        description={[
      ...
      <div className="text-xl text-[#FFFFFF]">
        <Title
          mainTitle="TORTOX"
          subTitle="gs 300r"
          content="The Tortox GS300-R Series gaming chairs are suitable for those who want the simpliest design with esports feeling. Manually control the handle to adjust the backrest angle. Made by inner softness pouch & a waterproof PU leather surface covering. Apply to any living room, bedroom, classroom, bar, and lounge etc."
        />
      </div>
       {/*  slider  */}
