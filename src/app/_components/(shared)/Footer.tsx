...
// const Footer = () => {
//   return (
//     <footer className="bg-[#1D1D1F80] text-white">
//       <div className="mx-auto  max-w-custom px-4 pt-8 pb-6 sm:px-6 lg:px-8">
//         <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-6">
//           <div className="text-center sm:text-left">
//             <p className="text-lg font-medium text-white">Footer Menu</p>
